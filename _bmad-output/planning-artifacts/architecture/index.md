# Architecture Decision Document — Jupiter

## Table of Contents

- [Architecture Decision Document — Jupiter](#table-of-contents)
  ...
  - [Project Structure & Boundaries](./project-structure-boundaries.md)
    ...
    - [Prisma Schema Models](./project-structure-boundaries.md#prisma-schema-models)
  ...
  - [Architecture Validation Results](./architecture-validation-results.md)
    ...
    - [Gap Analysis Results & Resolutions](./architecture-validation-results.md#gap-analysis-results-resolutions)
